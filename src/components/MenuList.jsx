export function MenuList({
  ...
  if (!locations.length) {
    return <div className="not-found-institute">Институты не найдены!</div>;
  }
  ...
  return (
    <div className="menu-items" onScroll={handleScroll}>
      {locations.map((l) => (
        <div key={l.id} className="menu-item" onClick={() => handleSearch(l)}>
          ...
          {!instituteMap && (
            <div className="marker__btns">
              ...
              <div className="marker__btn--outer">
                <a
                  onClick={() => handleMenuCreateRoute(l)}
                  className="marker__btn"
                  href="#"
                  style={{ backgroundColor: l.color }}
                >
